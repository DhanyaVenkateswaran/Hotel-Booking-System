        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-7 py-4">
                    ...
                    <p class="text-muted">Lorem ipsum dolor sit amet. Ad error magni qui sint alias qui temporibus dolore vel animi earum est accusantium natus. Vel pariatur voluptatem sit optio tenetur aut quis error et iure inventore. Sed iste harum et quae possimus eum velit asperiores est perspiciatis quia id corrupti vero.</p>
                </div>
...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container pt-lg-5 pl-5 px-5">
            <h1 class="display-3">Explore hotels with us</h1>
    ...
    <div class="container">
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            <h1 class="display-4">Find the perfect hotel for You</h1>
            <p class="lead">Lorem ipsum dolor sit amet. Ad error magni qui sint alias qui temporibus dolore vel animi earum est accusantium natus. Vel pariatur voluptatem sit optio tenetur aut quis error et iure inventore. Sed iste harum et quae possimus eum velit asperiores est perspiciatis quia id corrupti vero.</p>
            <a href="map.php">Click here to view hotels on map</a>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 text-center font-weight-normal">Deluxe residence</h5>
                        </div>
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" style="height: 225px; width: 100%; display: block;" src="image/deluxe.png" data-holder-rendered="true">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 text-center font-weight-normal">Double doors</h5>
                        </div>
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="image/double.jpeg" data-holder-rendered="true" style="height: 225px; width: 100%; display: block;">
                        <div class="card-body">
                            <p class="card-text">Lorem ipsum dolor sit amet. Ad error magni qui sint alias qui temporibus dolore vel animi earum est accusantium natus. Vel pariatur voluptatem sit optio tenetur aut quis error et iure inventore. Sed iste harum et quae possimus eum velit asperiores est perspiciatis quia id corrupti vero.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 text-center font-weight-normal">Single symphony</h5>
                        </div>
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="image/single.webp" data-holder-rendered="true" style="height: 225px; width: 100%; display: block;">
                        <div class="card-body">
                            <p class="card-text">Lorem ipsum dolor sit amet. Ad error magni qui sint alias qui temporibus dolore vel animi earum est accusantium natus. Vel pariatur voluptatem sit optio tenetur aut quis error et iure inventore. Sed iste harum et quae possimus eum velit asperiores est perspiciatis quia id corrupti vero.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                        ...
                        <form role="form" autocomplete="off" method="post" id="multiStepRsvnForm">
                            <div class="rsvnTab">
                                ...
                                <div class="form-group row align-items-center">
                                    <label class="col-sm-3 col-form-label" for="roomType">Hotel Name
                                        <span class="red-asterisk"> *</span>
                                    </label>
                                    <div class="col-sm-9">
                                        <select required class="custom-select mr-sm-2"  name="roomType">
                                            <option value="<?php echo \models\RequirementEnum::DELUXE; ?>">ITC Grand Chola</option>
                                            <option value="<?php echo \models\RequirementEnum::DOUBLE; ?>">Taj Connemara</option>
                                            <option value="<?php echo \models\RequirementEnum::SINGLE; ?>">Residency Towers</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row align-items-center">
                                ...
                                <div class="form-group row align-items-center">
                                    <label class="col-sm-3 col-form-label" for="adults">Number of rooms
                                        <span class="red-asterisk"> *</span>
                                    </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row align-items-center">
                                    <label class="col-sm-3 col-form-label" for="children">Number of guests</label>
                                    <div class="col-sm-9">
